  ...
  return (
    <>
      <div className="flex flex-col items-center rounded-lg border shadow-md md:flex-row md:max-w-xl border-gray-700 bg-gray-800">
        <img loading="lazy" className="bg-white md:h-full w-full object-cover md:object-contain rounded-t-lg md:w-40 md:rounded-none md:rounded-l-lg" src={img} alt=""/>
        ...
        <div className="flex flex-col justify-between p-4 leading-normal text-center bg-gray-800 w-full lg:w-72 md:text-start">
          ...
          <div className="mb-3 font-normal text-gray-400">
            ...
            {certificate &&
            <div>
              <button className="text-white font-medium rounded-md text-sm px-2.5 py-2 mt-3 bg-blue-600 hover:bg-blue-700" onClick={openModal}>CONSTANCIA</button>
              <Modal isOpen={isOpenModal} closeModal={closeModal}>
                <img loading="lazy" src={certificate} alt="img__certificate" />
              </Modal>
            </div>
            }
          </div>
